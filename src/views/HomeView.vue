...
const list = [
  { id: 1, cover: 'https://picsum.photos/id/1018/200/300', title: 'Title 1', author: 'Author 1', date: '2021-01-01' },
...
<template>
  ...
  <div class="space-y-2">
    <el-card shadow="hover" class="h-[200px]" v-for="item in list" :key="item.id">
      <div>{{ item.title }}</div>
    </el-card>
  </div>
